...
city_dict = {'Urban': 0,'Semi_urban': 1,'Rural': 2}
...
def run_ml():
	...
	with col1:
		...
		city_category = st.selectbox("City Category",["Urban","Semi_urban","Rural"])
		stay_in_current_city = st.number_input("No of Years of Stay in Current City",1,10)
	
	with col2:
		marital_status = st.radio("Marital Status",("Single","Married"))
		product_category_1 = st.number_input("Electronics",0,20)
		product_category_2 = st.number_input("Food & Groceries",0,20)
		product_category_3 = st.number_input("Clothes",0,20)

	selected_options = {'Gender':gender,'Age':age,'Occupation':occupation, 'City_Category':city_category,
	'Stay_In_Current_City_Years':stay_in_current_city, 'Marital_Status':marital_status, 'Electronics':product_category_1,
	'Food_&_Groceries':product_category_2, 'Clothes':product_category_3}
